                ...
                <div className='mx-auto flex flex-col items-center lg:flex-row lg:gap-12'>
                  ...
                  <div className='lg:w-7/12'>
                    ...
                    <p className='mt-3 leading-loose'>
                      ...
                      法如尼公（ほうにょにこう）の願いにより設立されました。設立者は源頼光公の四男で、開山（初代住職）は源頼光公の四男永寿阿闍梨でした。
                    </p>
                    <p className='mt-3 leading-loose'>
                ...
                <div className='mx-auto flex flex-col items-center lg:flex-row lg:gap-12'>
                  ...
                  <div className='lg:w-7/12'>
                    ...
                    <p className='mt-3 leading-loose'>
                      ...
                      1671年(霊元天皇寛文十一年)に禅僧万愚和尚が寺を復興しました。更に1746年(桜町天皇延享三年)に、
                      現在の亀岡市にある臨済宗の法常寺の末寺となり、1804年(光格天皇文化元年)に公式に認められ、
                      尼寺（女性だけの寺）となりました。
                    </p>
                  </div>
                </div>
